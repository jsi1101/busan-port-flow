...
const driverGates = [
  { name: '북항 게이트', point: [35.1118, 129.0461], color: colors.gate },
  { name: '신선대 게이트', point: [35.1125, 129.0910], color: colors.gate },
  { name: '감만부두 게이트', point: [35.1036, 129.0978], color: colors.gate },
];
...
window.updateDriverMapPosition = (latitude, longitude) => {
  ...
  document.getElementById('driverMapHint').textContent = '파란 점이 현재 위치입니다. 게이트 색상과 예상 대기시간을 비교하세요.';
};
